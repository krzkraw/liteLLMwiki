...
func settingsAPIParityGroups() []settingsAPIParityGroup {
	return []settingsAPIParityGroup{
		...
		{
			title: "G0LiteLLaMa api.request routes",
			rows: []settingsAPIParityRow{
				{surface: "api.request GET /g0litellama/v1/status", backing: "RuntimeController.Status"},
				{surface: "api.request GET /g0litellama/v1/models", backing: "Catalog.Entries"},
				{surface: "api.request POST /g0litellama/v1/models/download", backing: "Catalog.Download"},
				{surface: "api.request GET /g0litellama/v1/runners", backing: "RunnerController.Snapshot"},
				{surface: "api.request POST /g0litellama/v1/runners", backing: "RunnerController.CreateRunner"},
				{surface: "api.request PATCH /g0litellama/v1/runners/{id}", backing: "RunnerController.UpdateRunner"},
				{surface: "api.request POST /g0litellama/v1/runners/{id}/start", backing: "RunnerController.StartRunner"},
				{surface: "api.request POST /g0litellama/v1/runners/{id}/stop", backing: "RunnerController.StopRunner"},
				{
					surface: "api.request POST /g0litellama/v1/runners/{id}/restart",
					backing: "RunnerController.RestartRunner",
				},
				{surface: "api.request POST /g0litellama/v1/runners/{id}/close", backing: "RunnerController.CloseRunner"},
				{surface: "api.request POST /g0litellama/v1/multimodal", backing: "RuntimeController.Multimodal"},
			},
		},
		{
...
func settingsActionMapLines() []string {
	return []string{
		...
		"POST /g0litellama/v1/runners/{id}/start|stop|restart|close",
		"Runner edits -> RunnerController.UpdateRunner -> PATCH /g0litellama/v1/runners/{id}",
		"Models d -> Catalog.Download -> POST /g0litellama/v1/models/download",
		"Wizard Enter -> RunnerController.CreateRunner -> POST /g0litellama/v1/runners",
	}
}
