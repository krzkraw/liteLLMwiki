...
const (
	realRuntimeEnv = "G0LITELLAMA_E2E_REAL"
	timeoutEnv     = "G0LITELLAMA_E2E_TIMEOUT_SECONDS"
)
...
func withOptionalIsolatedHome(combo RuntimeBackendCombo, run func() error) error {
	...
	if strings.TrimSpace(os.Getenv("G0LITELLAMA_E2E_LITERT_HOME")) != "" {
		return run()
	}

	home, err := os.MkdirTemp("", "g0litellama-e2e-home.")
	if err != nil {
