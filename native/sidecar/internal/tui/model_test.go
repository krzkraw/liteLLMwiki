...
func TestRunnerTabRendersSignalBoardWithRunnerReadiness(t *testing.T) {
	...
	for _, expected := range []string{
		...
		"Model       ● gemma4-e2b  /models/litert/main/gemma-4-E2B-it.litertlm",
...
func TestRunnerTabShowsOperationFlowAndSharedMethodParity(t *testing.T) {
	...
	for _, expected := range []string{
		...
		"Model file:    /models/litert/main/gemma-4-E2B-it.litertlm",
...
func TestRunnerTabShowsSettingsMatrixWithPatchFields(t *testing.T) {
	...
	for _, expected := range []string{
		...
		"m    Model path    /models/litert/main/gemma-4-E2B-it.litertlm modelPath -> RunnerController.UpdateRunner",
