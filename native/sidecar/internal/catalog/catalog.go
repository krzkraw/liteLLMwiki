...
func NewDefault(modelRoot string, options ...Option) *Catalog {
	...
	catalog.add(Entry{
		...
		TargetPath: filepath.Join(modelRoot, "llamacpp", "main", "gemma-4-E2B-it-qat-UD-Q4_K_XL.gguf"),
		Runtime:    "llamacpp",
		Role:       "main",
		Required:   true,
	})
	catalog.add(Entry{
		...
		TargetPath: filepath.Join(modelRoot, "llamacpp", "main", "Qwen3.5-2B-IQ4_NL.gguf"),
		Runtime:    "llamacpp",
		Role:       "main",
		Required:   true,
	})
	catalog.add(Entry{
		...
		TargetPath: filepath.Join(modelRoot, "llamacpp", "main", "Qwen3.5-0.8B-UD-Q8_K_XL.gguf"),
		Runtime:    "llamacpp",
		Role:       "main",
		Required:   true,
	})
	catalog.add(Entry{
		...
		TargetPath: filepath.Join(modelRoot, "llamacpp", "embedding", "Qwen3-Embedding-0.6B-q8_0.gguf"),
		Runtime:    "llamacpp",
		Role:       "embedding",
		Required:   true,
	})
	catalog.add(Entry{
		...
		TargetPath: filepath.Join(modelRoot, "llamacpp", "embedding", "Qwen3-Embedding-0.6B-iq4_nl.gguf"),
		Runtime:    "llamacpp",
		Role:       "embedding",
		Required:   true,
	})
	catalog.add(Entry{
		...
		TargetPath: filepath.Join(modelRoot, "llamacpp", "reranking", "Qwen3-Reranker-0.6B-Q4_K_M.gguf"),
		Runtime:    "llamacpp",
		Role:       "reranking",
		Required:   true,
	})
	catalog.add(Entry{
		...
		TargetPath: filepath.Join(modelRoot, "litert", "main", "gemma-4-E2B-it.litertlm"),
		Runtime:    "litert",
		Role:       "main",
		Required:   true,
	})
	catalog.add(Entry{
		...
		TargetPath: filepath.Join(modelRoot, "litert", "browser", "gemma-4-E2B-it-web.litertlm"),
		Runtime:    "litert",
		Role:       "browser",
		Required:   true,
	})
	catalog.add(Entry{
		...
		TargetPath: filepath.Join(modelRoot, "litert", "embedding", "embeddinggemma-300M_seq2048_mixed-precision.tflite"),
		Runtime:    "litert",
		Role:       "embedding",
		Required:   true,
	})
